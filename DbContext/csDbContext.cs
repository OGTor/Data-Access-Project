...
public class csMainDbContext : Microsoft.EntityFrameworkCore.DbContext
{
    ...
    public DbSet<csSights> Sights { get; set; }
    public DbSet<csUser> Users { get; set; }
    DbSet<csComments> Comments { get; set; }
    DbSet<csAddress> Address { get; set; }
    ...
    public static csMainDbContext DbContext(string DbUserLogin) =>
        new csMainDbContext(csMainDbContext.DbContextOptions(csConfig.DbLoginDetails(DbUserLogin)).Options);
    ...
    public class SqlServerDbContext : csMainDbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                var connectionString = csConfig.DbSetActive.DbLogins.Find(
