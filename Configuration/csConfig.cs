...
{
    static public string Hello { get; } = $"Hello from namespace {nameof(Configuration)}, class {nameof(csConfig)}";
...
public class DbLoginDetail
{
    ...
    public string DbConnectionString => csConfig.ConfigurationRoot.GetConnectionString(DbConnection);
}
